      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '1rem' }}>
          <label style={{ color: 'var(--text-secondary)' }}>
            Master Password{' '}
            <span style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>(remember this — it cannot be recovered)</span>
          </label><br />
          <input
        ...
        <button
          ...
          style={{ width: '100%', padding: '0.75rem', background: 'var(--accent-green)', color: 'white', border: 'none', borderRadius: 6, cursor: 'pointer' }}
        >
